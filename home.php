...
<div class="main">
	...
	<section id="content">
	<div>
		<h2>Welcome to the Monkey House!</h2>
	</div>
	<div>
	<p>
		Monkey House is a Real Estate Website for Buying, Selling or Renting Properties Simply Search for the property you want to buy you can also take it for rent if the option is available.		
	</p><br/><br/>
	<center>
...
{
	$_COOKIE[$s] = $_GET['search'];
	if (!isset($_COOKIE[$s]))  
    {
        setcookie($_GET['search'],"hello" , time()+3600);
    }  
